...
- (void)viewDidLoad
{
    ...
    // 设置TabBar字体颜色
    [UITabBar.appearance setTintColor:COLOR_RGB(203, 51, 45)];
    
    // 设置TabBar背景颜色
    [UITabBar.appearance setBarTintColor:COLOR_RGB(251, 251, 251)];
    
    // 标签栏透明效果
    [self.tabBar setBackgroundImage:[UIImage imageWithColor:COLOR_RGB(251, 251, 251)]];
                   ...
                   tabBarItemEnabled:(BOOL)enabled
{
    ...
    if (enabled) {
        ...
        naviViewController.tabBarItem.titlePositionAdjustment = UIOffsetMake(0, -2);
        [naviViewController.tabBarItem setTitleTextAttributes:@{NSFontAttributeName:FONT_TAB_BAR_TITLE_DEFAULT,
                                                                NSForegroundColorAttributeName:COLOR_RGB(103, 103, 103)}
                                                     forState:UIControlStateNormal];
        [naviViewController.tabBarItem setTitleTextAttributes:@{NSFontAttributeName:FONT_TAB_BAR_TITLE_DEFAULT,
                                                                NSForegroundColorAttributeName:COLOR_RGB(203, 51, 45)}
                                                     forState:UIControlStateSelected];
        // 标签栏图标
        CGSize imageSize = CGSizeMake(TAB_BAR_HEIGHT*0.48, TAB_BAR_HEIGHT*0.48);
