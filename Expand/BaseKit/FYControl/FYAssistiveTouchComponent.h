...
typedef NS_ENUM(NSUInteger, FYAssistiveTouchStyle) {
    FYAssistiveTouchStylePop,   // 弹出 #Default
    FYAssistiveTouchStyleShape, // 扇形 #未实现
};

@interface FYAssistiveTouchComponent : UIView
@property (nonatomic, strong) UIButton *spreadButton;
@property (nonatomic, assign) FYAssistiveTouchStyle style;
...
@property (nonatomic, assign) CGFloat alphaOfShow; /**< 显示状态透明度*/
@property (nonatomic, assign) CGFloat alphaOfHidden; /**< 隐藏状态透明度*/
