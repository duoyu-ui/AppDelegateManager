...
//    NSString *msg = NSLocalizedString(@"系统错误", nil);
//    if (code == -1) {
//        msg = NSLocalizedString(@"系统错误", nil);
//    }
//    if (code == -2) {
//        msg = NSLocalizedString(@"取消了分享", nil);
//    }
//    if (code == -3) {
//        msg = NSLocalizedString(@"发送失败", nil);
//    }
//    if (code == -4) {
//        msg = NSLocalizedString(@"授权失败", nil);
//    }
//    if (code == -5) {
//        msg = NSLocalizedString(@"微信不支持", nil);
//    }
//    if (code == -95) {
//        msg = NSLocalizedString(@"系统错误", nil);//分享href或文本为空、图片路径不对或加载失败或其他错误
//    }
//    if (code == -96) {
//        msg = NSLocalizedString(@"图片超过限制", nil);
//    }
//    if (code == -97) {
//        msg = NSLocalizedString(@"图片超过限制", nil);
//    }
//    if (code == -98) {
//        msg = NSLocalizedString(@"微信未安装", nil);
//    }
//    if (code == -99) {
//        msg = NSLocalizedString(@"系统错误", nil);//无效的appid
//    }
