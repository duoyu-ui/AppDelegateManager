...
@protocol CFCDirectionViewControllerInterfaceOrientationProtocol <NSObject>
@required
...
@interface CFCDirectionViewController : CFCNetworkViewController <CFCDirectionViewControllerInterfaceOrientationProtocol>
