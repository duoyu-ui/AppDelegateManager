...
@interface CFCCollectionRefreshViewController : CFCBaseCoreViewController <UICollectionViewDelegateFlowLayout, CFCCollectionRefreshViewWaterFallLayoutDelegate>
