...
#pragma mark 导航栏按钮偏移
typedef NS_ENUM(NSInteger, CFCNavBarButtonOffsetType) {
    CFCNavBarButtonOffsetTypeNone = 1,   // 无
    CFCNavBarButtonOffsetTypeLeft,       // 左偏移
    CFCNavBarButtonOffsetTypeRight,      // 右偏移
};
...
- (UIBarButtonItem *)createBarButtonItemWithImage:(NSString *)image
                                           target:(id)target
                                           action:(SEL)action
                                       offsetType:(CFCNavBarButtonOffsetType)offsetType;
- (UIBarButtonItem *)createBarButtonItemWithImage:(NSString *)image
                                           target:(id)target
                                           action:(SEL)action
                                       offsetType:(CFCNavBarButtonOffsetType)offsetType
