...
@interface FYCountDownObject ()
@property(nonatomic, retain) dispatch_source_t timer;
@end


@implementation FYCountDownObject

#pragma mark 每秒走一次，回调block
- (void)countDownWithSecondBlock:(void (^)(void))secondBlock
{
    [self countDownWithSecond:1 block:secondBlock];
}
...
- (void)countDownWithSecond:(NSInteger)second block:(void (^)(void))secondBlock
{
    if (_timer == nil) {
        ...
        dispatch_source_set_timer(_timer, dispatch_walltime(NULL, 0), second*NSEC_PER_SEC, 0);
