//
//  FYGamesMode1QPGroupSubTableViewCell.m
//  ProjectCSHB
//
...
@interface FYGamesMode1QPGroupSubTableViewCell ()
// 图片
...
@implementation FYGamesMode1QPGroupSubTableViewCell
...
- (void)setModel:(FYGamesMode1QPGroupSubModel *)model
{
...
{
    if (self.delegate && [self.delegate respondsToSelector:@selector(didSelectRowAtGamesMode1QPGroupSubModel:indexPath:)]) {
        [self.delegate didSelectRowAtGamesMode1QPGroupSubModel:self.model indexPath:self.indexPath];
    }
}
