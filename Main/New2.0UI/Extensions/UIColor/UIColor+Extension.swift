...
extension UIColor {
    ...
    ///
    /// - Returns: 151515
    class func appThemeHexBlackColor() ->UIColor {
    ...
    ///
    /// - Returns: 半透明背景色
    class func translucentBgColor() ->UIColor {
        
        return colorWithHexStr("FFFFFF", alpha: 0.06)
    }
    ...
    ///
    /// - Returns: C5C7D2
    class func btnDisableImageColor() ->UIColor {
    ...
    class func hudBackgroundColor() -> UIColor {
        ...
        return self.colorWithHexStr("585867")
    }
