...
NSString * const kRCDBaseSettingTableViewCellIdentifier = @"RCDBaseSettingTableViewCellIdentifier";
...
{
    RCDBaseSettingTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:kRCDBaseSettingTableViewCellIdentifier];
    if (!cell) {
        cell = [[RCDBaseSettingTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:kRCDBaseSettingTableViewCellIdentifier];
...
- (void)initialize
{
    ...
    self.bottomLine.backgroundColor = TBSeparaColor;
