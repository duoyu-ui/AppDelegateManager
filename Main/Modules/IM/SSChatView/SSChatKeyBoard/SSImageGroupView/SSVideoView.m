...
-(instancetype)initWithItem:(SSImageGroupItem *)item{
    if(self = [super init]){
        ...
        [_mBackButton setTitle:NSLocalizedString(@"返回", nil) forState:UIControlStateNormal];
        ...
        [_playLeftButton setTitle:NSLocalizedString(@"播放", nil) forState:UIControlStateNormal];
        [_playLeftButton setTitle:NSLocalizedString(@"暂停", nil) forState:UIControlStateSelected];
...
-(instancetype)initWithItem:(SSImageGroupItem *)item{
    if(self = [super init]){
        ...
        NSLog(NSLocalizedString(@"本地视频地址%@", nil),_item.videoPath);
        ...
        _playerLayer.frame = CGRectMake(0, 0, FYSCREEN_Width, FYSCREEN_Height);
