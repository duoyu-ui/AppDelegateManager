...
#import "SSChatUnderRemindCell.h"
@interface SSChatUnderRemindCell()
...
@end
@implementation SSChatUnderRemindCell
...
- (void)setModel:(FYMessagelLayoutModel *)model{
    ...
    SSChatUnderRemindModel *winModel = [SSChatUnderRemindModel mj_objectWithKeyValues:[model.message.text mj_JSONObject]];
...
@end
@implementation SSChatUnderRemindModel
