...
#import "SSChatBagBagCowMeWinCell.h"
@interface SSChatBagBagCowMeWinCell()
...
@end
@implementation SSChatBagBagCowMeWinCell
- (void)setModel:(FYMessagelLayoutModel *)model{
    ...
    self.dateLab.text = msg.lastObject;
