...
#import "SSChatDoZcontinCell.h"

@interface SSChatDoZcontinCell()
...
@end
@implementation SSChatDoZcontinCell
...
- (void)setModel:(FYMessagelLayoutModel *)model{
    ...
    SSChatDoZcontinModel *winModel = [SSChatDoZcontinModel mj_objectWithKeyValues:[model.message.text mj_JSONObject]];
...
@end
@implementation SSChatDoZcontinModel
