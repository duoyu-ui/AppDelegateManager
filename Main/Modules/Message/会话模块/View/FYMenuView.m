...
@interface FYMenuView()
@property (strong, readwrite, nonatomic) FYMenu *menu;
             ...
             menuItems:(NSArray *)menuItems
{
    ...
    FYMenuContainerView *overlay = [[FYMenuContainerView alloc] initWithFrame:view.bounds];
...
- (void)menuItemClick:(UIButton *)sender
{
    ...
    FYMenuItem *menuItem = _menuItems[button.tag];
...
- (UIView *)makeContentView{
    ...
    //获得最大item的宽度和高度
    for (FYMenuItem *menuItem in _menuItems) {
