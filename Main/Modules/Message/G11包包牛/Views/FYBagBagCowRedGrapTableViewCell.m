//
//  FYBagBagCowRedGrapTableViewCell.m
//  ProjectCSHB
//
...
@implementation FYBagBagCowRedGrapTableViewCell
...
{
    if (![cellModel isKindOfClass:[FYBagBagCowRedGrapModel class]]) {
        return;
    }
    
    FYBagBagCowRedGrapModel *model = (FYBagBagCowRedGrapModel *)cellModel;
