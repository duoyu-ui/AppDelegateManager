 ...
 *      `-simplePing:didabnormal:` delegate callbacks as ICMP packets arrive.
 *
 ...
 *      unsolicited ICMP packets, via the `-simplePing:didabnormal:` delegate 
 *      callback).
 *
 ...
 *      `-simplePing:didfail:sequenceNumber:error:` delegate callback (unless you 
...
- (void)simplePing:(SimplePing *)pinger didfail:(NSData *)packet sequenceNumber:(uint16_t)sequenceNumber error:(NSError *)error;
...
- (void)simplePing:(SimplePing *)pinger didabnormal:(NSData *)packet;
