...
//        [_contentView addSubview:closeBtn];
        ...
        saftBtn.titleLabel.font = [UIFont systemFontOfSize:17];
...
//        button.tag =  i;
    ...
    NSArray* subtitleArray =@[NSLocalizedString(@"取消", nil),NSLocalizedString(@"确定", nil)];
...
//        [button addTarget:self action:@selector(funAdsButtonClickItem:) forControlEvents:UIControlEventTouchUpInside];
    ...
    btn0.backgroundColor = HEXCOLOR(0xcccccc);
    [btn0 setTitleColor:HEXCOLOR(0x666666) forState:UIControlStateNormal];
    btn0.layer.borderColor = HEXCOLOR(0xcccccc).CGColor;
...
//    [btn1 setTitleColor:HEXCOLOR(0xf7f9fa) forState:UIControlStateNormal];
    ...
    btn1.backgroundColor = HEXCOLOR(0xfd4c56);
...
- (void)richElementsInViewWithModel:(id)model{
    [_saftBtn setTitle:[NSString stringWithFormat:@"%@",NSLocalizedString(@"申请代理", nil)] forState:UIControlStateNormal];
    
    UIButton* bt0 =_btns[0];
    UIButton* bt1 =_btns[1];
    
    [bt0 setTitleColor:HEXCOLOR(0x333333) forState:UIControlStateNormal];
    bt0.titleLabel.font = [UIFont systemFontOfSize:15];
    [bt0 setTitle:[NSString stringWithFormat:@"%@",model] forState:UIControlStateNormal];
    bt0.contentHorizontalAlignment = UIControlContentHorizontalAlignmentCenter;
