...
-(void)initView{
    ...
    [lingQuBtn setTitle:NSLocalizedString(@" 领取", nil) forState:UIControlStateNormal];
    [lingQuBtn setTitle:NSLocalizedString(@"已领取", nil) forState:UIControlStateSelected];
    ...
    [xiangQingBtn setTitle:NSLocalizedString(@"活动详情", nil) forState:UIControlStateNormal];
