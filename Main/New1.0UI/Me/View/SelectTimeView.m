...
-(void)btnListView{
    ...
    UIImageView *tabView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"navBarBg"]];
    ...
    label.text = NSLocalizedString(@"快捷选择", nil);
    ...
    for (NSInteger i = 0; i < 6; i ++) {
        ...
        switch (i) {
            case 0:
                ...
                break;
            case 1:
                [btn setTitle:NSLocalizedString(@"昨天", nil) forState:UIControlStateNormal];
                break;
            case 2:
                [btn setTitle:NSLocalizedString(@"本周", nil) forState:UIControlStateNormal];
                break;
            case 3:
                [btn setTitle:NSLocalizedString(@"上周", nil) forState:UIControlStateNormal];
                break;
            case 4:
                [btn setTitle:NSLocalizedString(@"本月", nil) forState:UIControlStateNormal];
                break;
            case 5:
                [btn setTitle:NSLocalizedString(@"上月", nil) forState:UIControlStateNormal];
                break;
            default:
                break;
        }
