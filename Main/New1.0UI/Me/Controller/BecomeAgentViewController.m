...
- (void)viewDidLoad
{
    ...
    self.title = NSLocalizedString(@"代理规则", nil);
...
//        [loginBtn setTitle:NSLocalizedString(@"已经是代理", nil) forState:UIControlStateNormal];
//        loginBtn.backgroundColor = COLOR_X(160, 160, 160);
//    }
//    else{
//        [loginBtn setTitle:NSLocalizedString(@"申请代理", nil) forState:UIControlStateNormal];
