//
//  FYBankCardSelectTableViewCell.m
//  ProjectCSHB
//
...
@interface FYBankCardSelectTableViewCell ()
/**
 * 根容器组件
 */
...
@implementation FYBankCardSelectTableViewCell
...
- (void)createViewAtuoLayout
{
    ...
    CGFloat bankMarkSize = CFC_AUTOSIZING_WIDTH(25.0);
    ...
    UIImageView *selectedImageView = ({
        ...
        [imageView setImage:[UIImage imageNamed:@"icon_select_arrow"]];
